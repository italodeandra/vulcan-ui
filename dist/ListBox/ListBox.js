...
var ListBox = function ListBox(_ref) {
  ...
  var handleChange = function handleChange(before, prev) {
    var items;
  ...
  var handleSearch = function handleSearch(type, value) {
    return regeneratorRuntime.async(function handleSearch$(_context2) {
      while (1) {
  ...
  var handleTransferAll = function handleTransferAll(before, prev) {
    var items;
    return regeneratorRuntime.async(function handleTransferAll$(_context3) {
      while (1) {
